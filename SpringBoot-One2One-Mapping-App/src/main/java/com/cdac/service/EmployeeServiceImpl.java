...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public List<Employee> findByCityName(String cityName) {
		...
		Iterable<Employee> itr2 = employeeDao.findByAddressCityName(cityName);
	...
	@Override
	public List<Employee> findByAddressStateName(String stateName) {

		Iterable<Employee> itr3 = employeeDao.findByAddressStateName(stateName);

		List<Employee> lst3 = new ArrayList<Employee>();
		itr3.forEach(ele -> lst3.add(ele));
		return lst3;
	}
